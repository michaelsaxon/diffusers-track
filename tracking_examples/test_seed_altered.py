...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "ADDED FLAG. Where to save the noise initializations for the to_track samples."
        ),
    )
    parser.add_argument(
        "--track_samples_file",
...
def main(args):
    ...
    if accelerator.is_main_process:
        accelerator.init_trackers("celebqa_unconditional")
    ...
    if accelerator.is_main_process:
        ...
        if args.logger == "tensorboard":
            ...
            tracker.add_images("test_samples", images_processed.transpose(0, 3, 1, 2), 0)
        elif args.logger == "wandb":
            # Upcoming `log_images` helper coming in https://github.com/huggingface/accelerate/pull/962/files
            accelerator.get_tracker("wandb").log(
                {"test_samples": [wandb.Image(img) for img in images_processed], "epoch": 0},
                step=global_step,
            )
